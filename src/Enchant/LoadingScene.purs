module Enchant.LoadingScene where
...
newLoadingScene :: forall eff. Eff (e :: Enchant | eff) EnchantLoadingScene
newLoadingScene = ffi [""] "new enchant.LoadingScene();"


instance groupLoadingScene :: Group EnchantLoadingScene where
...
instance eventTargetLoadingScene :: EventTarget EnchantLoadingScene where
...
instance nodeLoadingScene :: Node EnchantLoadingScene where
