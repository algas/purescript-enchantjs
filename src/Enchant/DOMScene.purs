...
newDOMScene :: forall eff. Eff (e :: Enchant | eff) EnchantDOMScene
newDOMScene = ffi [""] "new enchant.DOMScene();"


instance groupDOMScene :: Group EnchantDOMScene where
...
instance eventTargetDOMScene :: EventTarget EnchantDOMScene where
...
instance nodeDOMScene :: Node EnchantDOMScene where
